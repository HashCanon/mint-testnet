...
export const CONTRACTS: Record<number, `0x${string}`> = {
  ...
  [sepolia.id]: '0x44780315AF4a3a26f4bB85A0629a85f69bc08732',//'0x7489c8D9518894969279C806274bA8fC0d93b6a5',//'0x1Ff1a87DE3980803B96edb4623424208218F0d71',//'0xdb45F8b19bed8e7be9F407c19a1Ce7d1623734e6',//'0x03626883eEd37a3ba619e593e2Bbe5Bd035d2f7A' 
} as const
